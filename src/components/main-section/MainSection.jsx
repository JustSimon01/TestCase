    ...
    <section className={`${styles.mainSection} min-h-[1069px] w-full`}>
      <div className='flex mt-72 p-5 max-w-[1440px] m-auto min-h-[528px]'>
        ...
        <div className='relative w-full max-w-[656px]'>
          ...
          <h1 className='text-white text-7xl text-left leading-tight mb-11'>Unleash the Next Generation of&nbsp;Gaming</h1>
        ...
        <img src={picture} alt='Солдат в зеленой экипировке' className='ml-2 max-w-[660px] max-h-[518px]' />
      </div>
    </section>
  );
}
